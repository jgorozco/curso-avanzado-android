...
import com.moob.ocrdnitest.PlanarYUVLuminanceSource;
import com.moob.ocrdnitest.PreferencesActivity;
...
public final class CameraManager {
  ...
  private static final int MIN_FRAME_WIDTH = 670; // originally 240
  private static final int MIN_FRAME_HEIGHT = 136; // originally 240
 ...
 //     Log.d("TEXT:", "CUADRADO:W:"+String.valueOf(newWidth)+" H:"+String.valueOf(newHeight));
