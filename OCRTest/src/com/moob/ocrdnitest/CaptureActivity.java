...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback
{
	...
	void handleOcrContinuousDecode(OcrResultFailure obj) {
		...
		if (CONTINUOUS_DISPLAY_METADATA) {
			...
			statusViewBottom.setTextSize(14);
			String s="No se ha encontrado texto, Acerque el movil y mantenga unos segundos. Aparecerán unos recuadros en el texto, después espere unos 5 segundos";
			statusViewBottom.setText(s);
			stopTimer();
		}
	}
	...
	private void retrievePreferences() {
		...
		characterBlacklist = "qazxswedcvfrtgbnhyujmkiol,.ñp>";//OcrCharacterHelper.getBlacklist(prefs, sourceLanguageCodeOcr);
		characterWhitelist = "QWERTYUIOPÑLKJHGFDSAZXCVBNM1234567890<";//OcrCharacterHelper.getWhitelist(prefs, sourceLanguageCodeOcr);
